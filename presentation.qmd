...
## Bioconductor {.nostretch}

Projet open source pour développer et partager des software en language R.

Encode de nombreuse structure de données pour la gestion de données omiques.

![](bioconductor.svg){width=50%}
...
\- Permet à des non initiés à la bioinformatique d'utiliser l'écosystème Bioconductor.
...
\- github.com/rformassspectrometry/QFeaturesGUI

[Disponibilité via Docker]{style="text-decoration: underline"}:

\- Une image pour chaque application sera disponible via Dockerhub

[Disponibilité via Bioconductor]{style="text-decoration: underline"}:

\- Le package sera disponible dans Bioconductor dans la release 3.25
...
## Merci pour votre attention ! {.merci-slide}

::: {.merci-links}

::: {.merci-link}
[Documentation]{.merci-link-title}

{{< qrcode https://rformassspectrometry.github.io/QFeaturesGUI/ width=180 height=180 >}}

[https://rformassspectrometry.github.io/QFeaturesGUI/](https://rformassspectrometry.github.io/QFeaturesGUI/)
:::

::: {.merci-link}
[GitHub]{.merci-link-title}

{{< qrcode https://github.com/rformassspectrometry/QFeaturesGUI width=180 height=180 >}}

[github.com/rformassspectrometry/QFeaturesGUI](https://github.com/rformassspectrometry/QFeaturesGUI)
:::
